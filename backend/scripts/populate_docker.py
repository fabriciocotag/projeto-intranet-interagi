...
# Cabeçalhos HTTP
headers = {"Accept": "application/json", "Host": "intranet.localhost"}
...
data = {
    ...
    "blocks": {
        "a10e3d32-d2b5-4442-923b-e1e5e720948c": {"@type": "title"},
        "52eb0f0d-6131-4696-a794-510bd086ebac": {"@type": "listing"},
    },
    "blocks_layout": {
        "items": [
...
AREAS = ["/marketing", "/ti", "/ti/desenvolvimento"]
